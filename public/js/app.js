...
exports = module.exports = __webpack_require__(1)();
exports.push([module.i, "#my-posts,.card{position:relative}.card,.card .content,.card .heading{padding:15px}#my-posts{width:90%;margin:0 auto}.card{margin-top:25px;width:100%;min-height:200px;background:#fff;box-shadow:1px 1px 10px #B5B4B6}.card .heading h3{font-size:2rem;font-weight:300;color:teal}.card .heading .datetime{color:#9B9B9B;font-style:italic;font-size:1rem}.card .content p{font-weight:300;line-height:1.5rem;color:#000;padding-bottom:25px}.card .content .readMore{position:absolute;bottom:0;right:0;text-decoration:none;color:teal;padding:25px}@media screen and (min-width:769px){#my-posts{position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-flow:row wrap;flex-flow:row wrap;-ms-flex-pack:distribute;justify-content:space-around;-ms-flex-line-pack:center;align-content:center}#my-posts .card{-webkit-box-flex:1;-ms-flex:1 200px;flex:1 200px;margin:10px}}", ""]);
...
exports = module.exports = __webpack_require__(1)();
exports.push([module.i, "#my-work,.work{position:relative}.work{width:calc(50% - 2px);height:auto;margin:1px;background:#000}.overlay,.text{position:absolute;overflow:hidden}.image{display:block;width:100%;height:200px;background-size:cover;background-repeat:no-repeat;background-position:center center}.overlay{bottom:100%;left:0;right:0;background-color:#008CBA;width:100%;height:0;transition:.5s ease}.work:hover .overlay{bottom:0;height:100%}.text{white-space:nowrap;color:#fff;font-size:20px;top:50%;left:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);-ms-transform:translate(-50%,-50%)}@media screen and (max-width:768px){#my-work{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-flow:row wrap;flex-flow:row wrap;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between}}@media screen and (min-width:769px){#my-work{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-flow:row wrap;flex-flow:row wrap;-webkit-box-pack:start;-ms-flex-pack:start;justify-content:flex-start}#my-work img{width:250xp;height:250px;margin:25px 0}}", ""]);
